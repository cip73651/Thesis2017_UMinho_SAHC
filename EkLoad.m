...
Ek = E0*(exp(-(-645/0.04*X + Y).^2/70000).*(sign( (-645/0.04*X + Y))/2 + 1/2) + exp(-(-645/0.04*X + Y).^ 2/ 400000).*(sign(-(-645/0.04*X + Y))/2 + 1/2)) * exp(-(645/0.04*X + Y).^2/2782000); % last version yields proper E4 only positive version
end
